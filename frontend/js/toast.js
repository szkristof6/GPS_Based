...
const toastDetails = {
    timer: 5000,
    success: {
        icon: './media/success.webp',
        text: 'Success: This is a success toast.',
    },
    error: {
        icon: './media/error.webp',
...
export function openToast(text, title, type){
    ...
    const icon = type !== "success" ? "./media/error.webp" : "/media/success.webp";
    toast.innerHTML = `<div class="column">
                         <img src="${icon}" class="toast_img"></img>
                         <span>${text}</span>
                      </div>
                      <img class="toast_img_close toast_close" src="./media/x.webp"></img>`;
